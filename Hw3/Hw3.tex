...
\begin{figure}[H]
    \centering\includegraphics[width=\linewidth]{train_set.png}
\end{figure}
...
\begin{figure}[H]
    \centering\includegraphics[width=\linewidth]{T_vs_param.png}
\end{figure}
...
\begin{figure}[H]
    \centering\includegraphics[width=\linewidth]{class_est.png}
\end{figure}

\begin{figure}
    \centering\csvautotabular{Class_err.csv}
...
\section*{Ex2}
\begin{figure}[H]
    \includegraphics[width=\linewidth]{MNist_random.png}
\end{figure}

\begin{figure}[H]
    \includegraphics[width=\linewidth]{AdaBoost.png}
\end{figure}
